...
var characterController = {
	...
	actions : function(action) {
		...
		case "hand_rest":
			characterController.currentCharacter.hand.gotoAndStop("rest");
			break;

		case "hand_cream":
			characterController.currentCharacter.hand.gotoAndStop("cream");
			break;

		case "hand_cannula":
			characterController.currentCharacter.hand.gotoAndStop("cannula");
			break;
	...
	speak : function(thisType) {
		...
		setTimeout(function() {
			doHighlight();
			characterController.talking(thisType);
		}, 400);
