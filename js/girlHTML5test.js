...
(lib.torso_1 = function() {
	...
	this.torso.setTransform(0,0,1,1,0,0,0,0.1,0);

	this.addChild(this.torso);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(-121.6,-173.1,243.3,346.2);
...
(lib.rightupperarm = function() {
	...
	this.upperarm_right.setTransform(0,0,1,1,0,0,0,142,107);

	this.addChild(this.upperarm_right);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(-24.1,-85.4,48.3,170.8);
...
(lib.rightlowerarm = function() {
	...
	this.shape.setTransform(11.9,101.2);

	this.instance = new lib.ClipGroup_3();
	this.instance.setTransform(0.3,-0.6,1,1,0,0,0,36,114.9);
...
p.nominalBounds = new cjs.Rectangle(-39.9,-119,79.9,238);
...
(lib.righthand = function() {
	...
	this.instance.setTransform(-2.6,-1.8,1,1,0,0,0,47.6,79);

	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFD6B2").s().p("");
	this.shape.setTransform(-1.3,0.4);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#000000").s().p("");

	this.addChild(this.shape_1,this.shape,this.instance);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(-53.5,-84.2,107.2,168.4);
...
(lib.leftupperarm = function() {
	...
	this.upperarm_left.setTransform(0.1,0,0.959,0.959,-4.5,0,0,-2.2,1);

	this.addChild(this.upperarm_left);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(-32,-88.1,63.8,176.1);
...
(lib.leftlowerarm = function() {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#000000").ss(2.8).p("AiqAXIBfADQB2gHB7gt");
	this.shape.setTransform(11.2,93.1);

	this.instance = new lib.ClipGroup_4();
	this.instance.setTransform(0.4,-0.5,1,1,0,0,0,33.4,105.9);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#D55795").s().p("AgdQDQg6l1hllmIgqiVQgXhVgMhAQghizAMjbQAKihAnjtQAKg6AJgfQAPgwAYghQAegoAwgPQAzgPAsAVQAhAQAcAsQARAcAVAzQAQAnATBVQAnCzAOBUQAYCTABB3QAABdgVDGQgUC/ADBoQAHEmBfEVIAUA6QhDAUgWAEQhgAQhIAAQghAAgdgDg");
	this.shape_1.setTransform(0.2,-0.1);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#000000").s().p("AgIRGIhNgFIgIgzQg5leholhIgQgzQgchXgMgqQgUhHgGg0QgnjEAIjRQAIi+AwjrQAQhPAHgVQASg/AggrQAfgoAtgXQAtgYAxgDQAygDAsAVQAzAXAlA2QAZAlAbBCQAsBtAUBQQAyDQAFEnQgBBBgHBRQgDAqgMBiQgMBngEAvQgHBSACBBQAGEWBbEEQAHASAYBXQgLANgiAPQhDAfhwAKQgoAEgyAAIg/gBg");

	this.addChild(this.shape_2,this.shape_1,this.instance,this.shape);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(-36.9,-109.5,74,219.2);
...
(lib.hairback = function() {
	...
	this.instance.setTransform(123.8,141.8,0.999,0.999,0,0,0,119.9,130.8);

	this.shape = new cjs.Shape();
	this.shape.graphics.f("#F15C3C").s().p("AhWUHQjFgKjOgZIimgYQgrhhhHjsIg/jZQgrCUgPCzQgHBaABA8Qhmgog+gpIgpghQjBvwFcr6QBtjvCVi6QBLhdA1gtQE8AZFlBKQH+BpD/CWQA/BcCFC4QBlCZgFBXQgKDMjAC8QhgBbhdA1QAFDpB3FeQA7CvA6CAQg1gMhogtIhdgqQAFBWAmBrQASA1ASAkQj4BunLAAQhtAAh3gGg");
	this.shape.setTransform(126,141.6,0.999,0.999);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#000000").s().p("AgtVzQjggGjggcQi2gXhLgWQgPgigjimIggifIgFBtIgJDoQhxgch5hSIhihMQiOpMA7oLQAwmgCtlnQB8kBCvjIQBXhlA/gxQHRg+I7DPQEeBnDBB0QCAB0B+EEQA/CDAmBqQhSEXhvCmQgiA0ghAkIgaAYIiNCkIBNErQBiFRBmC/QhkgXhpgyIhWgtIAWBNQAaBYAZA1QkiCYosAAIhugBg");
	this.shape_1.setTransform(127.8,139.5,0.999,0.999);

	this.addChild(this.shape_1,this.shape,this.instance);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(0,0,255.6,279.1);
...
(lib.facesmile = function() {
	...
	this.instance.setTransform(-2.7,-14.4,1,1,0,0,0,101.9,224.7);
...
(lib.lefthand = function() {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#000000").s().p("AAqDfQg0gCgqgRQgvgTgQibQgPiQAXgzIAfABIABByQAIB+AgBHIAPAQQAUANAngIQABg4AFhJQALiQAYhRIAqgkIgkG7QgPACgVAAIgIAAg");
	this.shape.setTransform(11.5,3.9);

	this.instance = new lib.ClipGroup_9();
	this.instance.setTransform(-1.2,-3.1,1,1,0,0,0,32.3,69);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFD6B2").s().p("AhlDRIgJgWICQmXIBNASIilGjQgMAEgJAAQgQAAgKgMg");
	this.shape_1.setTransform(-9.1,48.2);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFD6B2").s().p("AhNDLQgQgOgCgZQgDgaBCixIBAitIBBAlIifGEQgHgCgIgIg");
	this.shape_2.setTransform(-19,41);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFD6B2").s().p("");
	this.shape_3.setTransform(-0.4,-3.1);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#000000").s().p("AjXLtQgwgfgCgLIhQhqIgOhuQgGhTAAgKQABgGAOgzIBbkJQAKhzATiMQATiEAQhNQAOhGALglQARg6AYgrQAWgnAcgaQANgMAEgFQAEgFAKgUQAbgxArgPQAlgNAsAGQAkAGAWARQAJAHAOARIAPATQAWAaAUAoIAfBJQAeBJAXBXQA6DmgYD0QgFA6gKA5QgzDQiQDDQhIBhg+A4IhLggIhqBJQgYgNgZgPg");

	this.addChild(this.shape_4,this.shape_3,this.shape_2,this.shape_1,this.instance,this.shape);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(-36.6,-77.7,73.3,155.5);
...
(lib.girlHTML5test = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(1).to({regY:-123.2,rotation:0.4,x:350.9,y:223},0).wait(1).to({rotation:0.8,x:351.9,y:223.1},0).wait(1).to({rotation:1.2,x:352.8,y:223.2},0).wait(1).to({rotation:1.6,x:353.8,y:223.3},0).wait(1).to({rotation:2,x:354.8,y:223.4},0).wait(1).to({rotation:2.3,x:355.7,y:223.5},0).wait(1).to({rotation:2.7,x:356.7,y:223.6},0).wait(1).to({rotation:2.2,x:355.3,y:223.5},0).wait(1).to({rotation:1.6,x:354,y:223.3},0).wait(1).to({rotation:1.1,x:352.6,y:223.2},0).wait(1).to({rotation:0.5,x:351.3,y:223.1},0).wait(1).to({rotation:0,x:350,y:223},0).wait(4));

	// neck
	this.instance_6 = new lib.neck_1();
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(1).to({regY:139.5,rotation:0.4,x:340.4,y:224.8},0).wait(1).to({rotation:0.8,x:341.4},0).wait(1).to({rotation:1.2,x:342.3},0).wait(1).to({rotation:1.6,x:343.3,y:224.9},0).wait(1).to({rotation:2,x:344.2,y:224.8},0).wait(1).to({rotation:2.3,x:345.2,y:224.9},0).wait(1).to({rotation:2.7,x:346.1,y:225},0).wait(1).to({rotation:2.2,x:344.8,y:224.9},0).wait(1).to({rotation:1.6,x:343.5,y:224.8},0).wait(1).to({rotation:1.1,x:342.1},0).wait(1).to({rotation:0.5,x:340.8},0).wait(1).to({rotation:0,x:339.5},0).wait(4));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(591.9,835.3,339.2,1293);
